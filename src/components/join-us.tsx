  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute inset-0 flex items-center justify-center text-center p-4 transition-opacity duration-300 ${
      ...
      {/* Join us button */}
      <button className="w-36 md:w-52 py-3 bg-foreground text-background font-bold text-sm tracking-wide uppercase border-2 border-transparent border-t-white hover:bg-background hover:text-foreground hover:border-foreground transition-all duration-300">
        Join us
      </button>
    </motion.div>
  );
...
export function JoinUsSection() {
  return (
    <section id="join-section" className="relative w-full bg-background pt-0 md:pt-4 pb-16 md:pb-24 px-4 sm:px-6 lg:px-10 md:snap-start">
